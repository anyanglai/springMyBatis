...
public interface ProviderMapper {
    ...
    /**
     * @Description:通过code和name查询到供应商信息
     * @param: [proName]
     * @return: java.util.List<com.bdqn.pojo.Provider>
     * @Date: 2019/07/02 15:17
     */
    List<Provider> selectProvidersByCodeAndName(@Param("queryProCode") String queryProCode, @Param("queryProName")String queryProName);
