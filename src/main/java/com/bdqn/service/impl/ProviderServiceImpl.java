...
public class ProviderServiceImpl implements ProviderService {
     ...
     * @param queryProCode
     * @param queryProName
     * @Description: 根据供应商code与name查询供应商信息
     * @param: []
     * @return: java.util.List<com.bdqn.pojo.Provider>
     * @Date: 2019/07/02 15:15
     */
    ...
    @Override
    public List<Provider> finderProvidersByCodeAndName(String queryProCode, String queryProName) {
        return providerMapper.selectProvidersByCodeAndName(queryProCode,queryProName);
    }
}
